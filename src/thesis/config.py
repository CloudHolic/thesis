...
# Assumes a source checkout or an editable installation, which is how all three environments install this package.
# THESIS_CONFIG overrides it when that fails.
